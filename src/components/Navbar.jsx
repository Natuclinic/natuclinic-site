...
const MenuLink = ({ link, onClick }) => (
    link.path ? (
        <button
            ...
            className="text-lg font-sans text-natu-brown/80 hover:text-natu-brown hover:pl-2 transition-all duration-300 bg-transparent border-0 p-0 text-left cursor-pointer"
        >
            {link.label}
        </button>
    ) : (
        <a
            ...
            className="text-lg font-sans text-natu-brown/80 hover:text-natu-brown hover:pl-2 transition-all duration-300 no-underline"
        >
            {link.label}
        </a>
    )
                    ...
                    {menuItems.map((item, i) => (
                        ...
                        >
                            {item.megaMenu ? (
                                ...
                                <a href={item.href} target="_blank" rel="noopener noreferrer" className="text-[13px] tracking-widest font-medium text-natu-brown no-underline relative font-sans">
                                    {item.label}
                                </a>
                            )}
                                                    ...
                                                    {item.megaMenu.featured && (
                                                        <div className="col-span-4 flex flex-col gap-5 group/featured">
                                                            ...
                                                            <div className="flex flex-col gap-2">
                                                                <h4 className="text-xl font-sans font-medium text-natu-brown">
                                                                    {item.label}
                                                                </h4>
                                                                <p className="text-sm font-sans font-normal text-gray-500 leading-relaxed max-w-[280px] [text-wrap:balance]">
