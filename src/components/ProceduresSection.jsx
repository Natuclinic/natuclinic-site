...
const ProceduresSection = () => {
    ...
    const procedimentos = [
        ...
        { title: "Harmonização Facial", category: "Estética Facial", imageUrl: "/harmonizacao-facial.jpg", theme: "var(--theme-brown)", path: "/procedimentos/harmonizacao-facial", description: "Realce a beleza dos seus traços com naturalidade e segurança." },
