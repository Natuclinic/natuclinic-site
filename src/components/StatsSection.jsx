...
const StatsSection = () => {
    ...
    return (
        <section ref={containerRef} className="py-12 md:py-16 bg-white">
            <div className="desktop-container">
                ...
                >
                    <div className="bg-[#F9F7F5] rounded-[2.5rem] py-16 px-6 md:px-20 border border-natu-brown/5 h-full w-full">
                        <div className="mx-auto max-w-5xl space-y-12 md:space-y-16">
                            <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center">
                                <span className="text-[10px] md:text-xs font-sans font-bold tracking-[0.3em] uppercase text-natu-brown/40 block">
                                    Excelência Comprovada
                                </span>
                                <div className="text-4xl font-sans font-bold text-natu-brown lg:text-5xl">
                                    <BlurText
                                        text="Confiança que se constrói com resultados"
                                        className="font-sans font-bold text-natu-brown justify-center"
                                        delay={200}
                                        animateBy="words"
                                        direction="top"
                                    />
                                </div>
                                <p className="font-sans font-light text-gray-500 text-lg leading-relaxed">
                            ...
                            <div className="grid gap-x-12 gap-y-20 md:grid-cols-3 *:text-center">
                                {ratings.map((stat, i) => (
                                    <div key={i} className="stat-item flex flex-col items-center group">
                                        <div className="text-5xl lg:text-7xl font-sans font-bold text-natu-brown flex items-center gap-3 mb-8 transition-transform duration-500 group-hover:scale-105">
                                            <CountUp
                                                to={stat.to}
                                        ...
                                        {/* Minimalist Divider */}
                                        <div className="w-full max-w-[200px] md:max-w-xs h-[1px] bg-natu-brown/10 mb-6 relative overflow-hidden">
                                        ...
                                        <p className="font-sans font-bold text-natu-brown/40 uppercase tracking-[0.2em] text-[10px]">
                                            {stat.label}
                                        </p>
                                    </div>
                                ))}
                            ...
                            <div className="flex justify-center pt-8">
                                <div className="flex -space-x-2 overflow-hidden p-2">
                                    ...
                                    <div className="flex items-center justify-center w-10 h-10 rounded-full border-2 border-white bg-gray-50 text-gray-600 text-xs font-medium z-10 relative">
                                        +100
                                    </div>
                                    <button className="flex items-center justify-center -ml-2 translate-x-4 w-10 h-10 rounded-full border-dashed border border-gray-300 bg-white hover:bg-gray-50 active:bg-gray-100 text-gray-400 z-0 cursor-pointer" aria-label="Add user">
