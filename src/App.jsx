...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <a href="https://wa.me/5561992551867?text=Ol%C3%A1%2C%20vim%20pelo%20site%20da%20Natuclinic%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es." target="_blank" rel="noopener noreferrer" aria-label="Falar com Natuclinic Taguatinga" className="fixed bottom-10 right-10 bg-natu-brown text-white w-14 h-14 rounded-full flex items-center justify-center hover:scale-110 transition-transform z-[9999] shadow-lg">
        <Unicon name="whatsapp" size={32} />
      </a>
